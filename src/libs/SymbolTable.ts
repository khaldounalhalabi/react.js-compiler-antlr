...
export function populateTable(table: SymbolTable) {
    ...
    function populateNestedTable(
        container: {
            appendChild: (arg0: HTMLTableElement) => void;
    ...
    function addRow(row: {
        insertCell: () => { (): any; new(): any; textContent: string; };
