...
import { FunctiondeclerationContext } from "./ReactParser";
import { ExpressionLableContext } from "./ReactParser";
import { ConsoleLogexpressionLabelContext } from "./ReactParser";
import { AssignmentLabelContext } from "./ReactParser";
...
export interface ReactListener extends ParseTreeListener {
	 ...
	 * labeled alternative in `ReactParser.statement`.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by the `functiondecleration`
	 * labeled alternative in `ReactParser.statement`.
	 * @param ctx the parse tree
	 */
	enterFunctiondecleration?: (ctx: FunctiondeclerationContext) => void;
	/**
	 * Exit a parse tree produced by the `functiondecleration`
	 * labeled alternative in `ReactParser.statement`.
	 * @param ctx the parse tree
	 */
	exitFunctiondecleration?: (ctx: FunctiondeclerationContext) => void;

	/**
	 * Enter a parse tree produced by the `expressionLable`
	 * labeled alternative in `ReactParser.statement`.
	 * @param ctx the parse tree
	 */
	enterExpressionLable?: (ctx: ExpressionLableContext) => void;
	/**
	 * Exit a parse tree produced by the `expressionLable`
	 * labeled alternative in `ReactParser.statement`.
	 * @param ctx the parse tree
	 */
	exitExpressionLable?: (ctx: ExpressionLableContext) => void;

	/**
	 * Enter a parse tree produced by the `consoleLogexpressionLabel`
	 * labeled alternative in `ReactParser.statement`.
	 * @param ctx the parse tree
	 */
	enterConsoleLogexpressionLabel?: (ctx: ConsoleLogexpressionLabelContext) => void;
	/**
	 * Exit a parse tree produced by the `consoleLogexpressionLabel`
	 * labeled alternative in `ReactParser.statement`.
	 * @param ctx the parse tree
	 */
	exitConsoleLogexpressionLabel?: (ctx: ConsoleLogexpressionLabelContext) => void;

	/**
	 * Enter a parse tree produced by the `assignmentLabel`
	 * labeled alternative in `ReactParser.statement`.
	 * @param ctx the parse tree
	 */
	enterAssignmentLabel?: (ctx: AssignmentLabelContext) => void;
	/**
	 * Exit a parse tree produced by the `assignmentLabel`
	 * labeled alternative in `ReactParser.statement`.
	 * @param ctx the parse tree
	 */
	exitAssignmentLabel?: (ctx: AssignmentLabelContext) => void;
