...
export interface ReactVisitor<Result> extends ParseTreeVisitor<Result> {
	...
	/**
	 * Visit a parse tree produced by the `functiondecleration`
	 * labeled alternative in `ReactParser.statement`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitFunctiondecleration?: (ctx: FunctiondeclerationContext) => Result;

	/**
	 * Visit a parse tree produced by the `expressionLable`
	 * labeled alternative in `ReactParser.statement`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitExpressionLable?: (ctx: ExpressionLableContext) => Result;

	/**
	 * Visit a parse tree produced by the `consoleLogexpressionLabel`
	 * labeled alternative in `ReactParser.statement`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitConsoleLogexpressionLabel?: (ctx: ConsoleLogexpressionLabelContext) => Result;

	/**
	 * Visit a parse tree produced by the `assignmentLabel`
	 * labeled alternative in `ReactParser.statement`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitAssignmentLabel?: (ctx: AssignmentLabelContext) => Result;
